...
<body>
    ...
    $con = new mysqli("127.0.0.1", "root", "Goldtre9", "Nikhil");
        ...
        while ($row = $result->fetch_assoc()) { ?>
            <li style="display:flex;flex-direction:row;">
                <div>
                    ...
                    <form action="updatessql1.php/?target=<?php echo $row['id']; ?>" method="post" class="checke" style="display: flex;flex-direction:row">
